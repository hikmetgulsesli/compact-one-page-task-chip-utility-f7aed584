...
- - FR-001: Build a compact one-page Task Chip utility. It should let users create/edit short task chips, filter active/done/archive states, clear cache, export JSON, and recover gracefully from empty/error/localStorage states. Keep it compact and production-like, with all visible Stitch buttons and links wired to usefu…
...
- Short Operations - Compact One Page Task Chip Utility
- Short Editor - Compact One Page Task Chip Utility
- Settings and Preferences - Compact One Page Task Chip Utility
- Empty and Error Recovery - Compact One Page Task Chip Utility

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Short Operations - Compact One Page Task Chip Utility
- surface_id: SURF_SHORT_OPERATIONS
- unique_canvas_caption: Short Operations: summary metrics, primary list/board/table, filters, search, selected item preview, empty/loading/error states.
- purpose: Give the user the main operational view for inspecting, searching, filtering, and acting on Short data.
...
- data_entities: Short, ActivityEvent, Preference
...
SCREEN_SPEC_2:
- exact_screen_title: Short Editor - Compact One Page Task Chip Utility
- surface_id: SURF_SHORT_EDITOR
- unique_canvas_caption: Short Editor: form fields, required/optional indicators, validation messages, save/cancel controls, unsaved-state feedback.
- purpose: Let the user create, edit, validate, save, cancel, and recover Short changes.
...
- data_entities: Short, ValidationError
- visible_actions: ACT_SAVE_RECORD as form_submit, ACT_CANCEL_EDIT as secondary_button
- entry_exit_rules: SURF_SHORT_OPERATIONS -> Save returns to SURF_SHORT_OPERATIONS with persisted changes; cancel preserves existing data and closes the editor.
- design_guidance: Form layout must be clear and task-specific; do not invent payment, onboarding, or unrelated identity forms.

SCREEN_SPEC_3:
- exact_screen_title: Settings and Preferences - Compact One Page Task Chip Utility
...
- purpose: Let users adjust Short workflow preferences, saved filters, defaults, or product settings requested by the task.
...
- entry_exit_rules: SURF_SHORT_OPERATIONS -> Saved preferences immediately affect visible product state or show a clear confirmation.
...
- purpose: Keep the Short workflow usable when data is missing, filtered away, loading, failed, or corrupt.
...
- entry_exit_rules: SURF_SHORT_OPERATIONS, SURF_INSIGHTS -> Recovery returns to the active Short workflow and preserves unrelated state.
...
## PRODUCT_SURFACES
1. SURF_SHORT_OPERATIONS - Short Operations
   Purpose: Give the user the main operational view for inspecting, searching, filtering, and acting on Short data.
   Data: Short, ActivityEvent, Preference
...
2. SURF_SHORT_EDITOR - Short Editor
   Purpose: Let the user create, edit, validate, save, cancel, and recover Short changes.
   Data: Short, ValidationError
   ...
   Entry/exit: SURF_SHORT_OPERATIONS -> Save returns to SURF_SHORT_OPERATIONS with persisted changes; cancel preserves existing data and closes the editor.
...
3. SURF_SETTINGS_AND_PREFERENCES - Settings and Preferences
   ...
   Entry/exit: SURF_SHORT_OPERATIONS -> Saved preferences immediately affect visible product state or show a clear confirmation.
...
4. SURF_EMPTY_AND_ERROR_RECOVERY - Empty and Error Recovery
   ...
   Entry/exit: SURF_SHORT_OPERATIONS, SURF_INSIGHTS -> Recovery returns to the active Short workflow and preserves unrelated state.
